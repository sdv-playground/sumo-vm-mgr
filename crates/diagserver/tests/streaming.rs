...
use vm_diagserver::streaming::process_envelope_stream;
...
fn multi_component_separate_uploads() {
    use vm_diagserver::streaming::{process_raw_payload, validate_manifest};
...
fn multi_component_encrypted_separate() {
    use vm_diagserver::streaming::process_raw_payload;
